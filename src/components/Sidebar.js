                ...
                <div className="profile__contact profile__contact__row__1">
                    ...
                    <ul className="text-lg-center text-md-center text-sm-center profile__contact__h__listing profile__contact__h__ul">
                        <li className="d-block p-3">
                            <span className="fa fa-home fa-3x" aria-hidden="true"></span><span className="profile__contact__s__p">Bangalore</span>
                        </li>
                        <li className="d-block p-3">
                            <span className="fa fa-envelope fa-3x" aria-hidden="true"></span><span className="profile__contact__s__p">rajadileepkumar34@gmail.com</span>
                        </li>
                        {/* <li className="d-block p-3">
                            <span className="fa fa-globe fa-3x" aria-hidden="true"></span><span className="profile__contact__s__p">abc.com</span>
                        </li> */}
                        <li className="d-block p-3">
                            <span className="fa fa-phone fa-3x" aria-hidden="true"></span><span className="profile__contact__s__p">+91-8050359110</span>
                        </li>
                    </ul>
                </div>
